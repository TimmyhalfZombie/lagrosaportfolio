...
export const ProjectPlaceholder = ({ title, description, image, link }: ProjectPlaceholderProps) => {
  const content = (
    <div className="group cursor-pointer">
      ...
      <div className="space-y-3 px-1 group-hover:translate-x-1 transition-transform duration-300">
          ...
          <p className="font-josefin text-gray-400 text-lg leading-relaxed text-justify opacity-80 group-hover:opacity-100 transition-opacity">
